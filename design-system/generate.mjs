...
const FILES = {
  ...
  'components/buttons.html': card(
    ...
    <style>
      ...
      .primary { background:linear-gradient(135deg,#d97706,#c2410c); color:#fff; box-shadow:0 4px 16px rgba(194,65,12,.4); } .primary:hover { background:linear-gradient(135deg,#b45309,#9a3412); }
    ...
    <h2>Variants (md) — v2 : primaire 2b (amber-600→orange-700, blanc AA ≈ 4.8:1, hover 700→800)</h2>
    <div class="row">
