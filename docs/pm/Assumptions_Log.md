...
| A-013 | 2026-07-18 | F-022 : le résultat officiel d'une campagne (victoire/défaite, étoile) n'est stocké nulle part dans l'app. | Si D2 est retenue : champ `outcome` saisi manuellement à la clôture (extension d'US-010) + rétro-saisie SoC 1–3 par le Roi. Sinon la timeline n'affiche que les agrégats. |
| A-014 | 2026-07-18 | F-022 : la timeline est lisible par tous les rôles, y compris invités (cohérent avec A-003 et A-007 — `kvk_history` est déjà en lecture publique). | Pas de gate d'accès prévu. À invalider si le Roi veut réserver la vue aux membres connectés. |
