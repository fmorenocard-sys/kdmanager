...
| A-007 | 2026-07-11 | F-015 : la vue progression joueur est consultable par tous (cohérent avec A-003), pas uniquement par le joueur lui-même. | Pas de restriction de lecture sur `kvk_history`. À revoir si des joueurs s'y opposent. |
| A-008 | 2026-07-11 | F-015 : les titres/dates officiels de SoC 1 et SoC 2 ne sont pas confirmés (SoC 1 : « Tides of War » 17/9–6/11 2025 d'après le dossier Drive ; SoC 2 : « Storm of Stratagems » 2025 d'après le nom du fichier xlsx). | Les libellés du sélecteur de campagne devront être validés par le Roi lors de l'import US-013. |
