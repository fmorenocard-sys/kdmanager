...
| F-007 | User Profile & Auth | Authentification Google + Liaison avec un ID de Gouverneur. | Live | P0 | Fort | Firebase Auth |
...
| F-010 | RBAC (Rôles) | Gestion des rôles (King, Officer, Warrior). | Live | P0 | Fort | F-007 |
