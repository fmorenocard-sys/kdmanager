...
| F-022 | Timeline du Royaume | Frise chronologique des campagnes KvK (SoC 1 → courante) avec agrégats royaume (KP gagnés, morts, comptes, % objectif) et résultat officiel optionnel ; cartes cliquables vers l'historique F-015. Voir `Etude_Timeline_Royaume.md`. | À développer (proposé — décisions D1–D4 à arbitrer) | P2 | Moyen | F-015 (`kvk_history`) |
