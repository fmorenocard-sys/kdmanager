...
| F-019 | KvK Race — Dashboard de course | Vues Camps (duel hero + écart + variation), Royaumes (32 KD triables, pins 2997/1523) et Évolution multi-scans, dans l'app (page P-008). DKP de course paramétrable par campagne, distinct du DKP interne (BR-010). **Réservé King/Officer** (décision §9.4 du 2026-07-21, modèle BR-011). | À développer (**GO du Roi 2026-07-21** — Phase 1) | P1 | Fort | F-018 |
