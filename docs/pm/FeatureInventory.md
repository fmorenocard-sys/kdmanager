...
| F-019 | KvK Race — Dashboard de course | Vues Camps (duel hero + écart + variation), Royaumes (32 KD triables, pins 2997/1523) et Évolution multi-scans, dans l'app (page P-008). | À développer (proposé — arbitrage Roi requis, E-005) | P1 | Fort | F-018, décision formule DKP (A-005) |
