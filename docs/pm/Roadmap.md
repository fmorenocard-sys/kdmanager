...
* **Runbook d'onboarding capturé (2026-08-18)** : `docs/pm/Runbook_Onboarding_Royaume.md` documente de bout en bout le processus vécu sur le pilote KD 3341 (infra, marque blanche, règles, Functions, ingestion, Race, rôles, recette) avec ses pièges, notamment le registre cross-tenant complet (incident du 07/08 + rechute résiduelle nettoyée le 18/08). Complète `Etude_Industrialisation_Onboarding.md` (le cadrage stratégique) d'un mode d'emploi opérationnel reproductible — préalable factuel à toute automatisation voie A future.
