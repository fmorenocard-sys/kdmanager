...
* **Attendu :**
  ...
  * **E-005 [GO — décision Roi 2026-07-21, voir `Etude_Fusion_KvK_Manager.md`]** : module « KvK Race » absorbant le KvK Manager Python. *Objectif : course à l'étoile centralisée dans l'app avant la prochaine saison (estimée ~oct.–nov. 2026). Périmètre acté : Phase 1 (ingestion scans F-018 + dashboard course F-019) à exécuter pendant l'inter-saison en cours, Phase 2 (analytique F-020) ensuite ; **Phase 3 scouting abandonnée** (F-021/US-022, A-012 invalidée). Restent à trancher : §9.3 priorité relative vs US-008/F-014, §9.4 visibilité de la vue course. Dépendances : Cloud Storage, audit Rules BUG-002 ; cadre DKP arbitré (BR-010). Risques : format des scans tiers, coûts Firestore/Storage, parité des calculs Python→JS.*
